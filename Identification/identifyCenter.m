...
dados = importdata("C:\Users\pdias\Desktop\Tese\Programação\BUV_V2\dataC.txt");
...
Theta = importdata("C:\Users\pdias\Desktop\Tese\Programação\BUV_V2\ParametrosC.txt")';

Theta = Theta([1:3,5:6,13:15,17:21,23:31,34,32]);
...
WN1 = 1e-5;  %Desvio padrão na Velocidade (Nu)
...
%    Ntau = [tau1,tau2,tau3,tau4,tau5,tau6]';
    ...
    g5 = -451*(sin(eta5)*cos(eta4));
    g6 = -451*(cos(eta5)*cos(eta4));
%    Ng = [g1,g2,g3,0,0,0]';

    V = [dNu1 0 0 0 0 Nu1 0 0 0 0 QNu1 0 0 0 0 bNu1 0    0    bQNu1 0     0     g1 0  0;
         0 dNu2 0 0 0 0 Nu2 0 0 0 0 QNu2 0 0 0 0    bNu2 0    0     bQNu2 0     g2 0  0;
         0 0 dNu3 0 0 0 0 Nu3 0 0 0 0 QNu3 0 0 0    0    bNu3 0     0     bQNu3 g3 0  0;
         0 0 0 dNu5 0 0 0 0 Nu5 0 0 0 0 QNu5 0 0    0    0    0     0     0     0  g5 g6;
         0 0 0 0 dNu6 0 0 0 0 Nu6 0 0 0 0 QNu6 0    0    0    0     0     0     0  0  0;
        ];
