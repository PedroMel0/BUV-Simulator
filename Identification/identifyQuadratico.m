...
dados = importdata("C:\Users\pdias\Desktop\Tese\Programação\BUV_V2\dataq.txt");
...
Theta = importdata("C:\Users\pdias\Desktop\Tese\Programação\BUV_V2\Parametrosq.txt")';

Theta = Theta([1:3,5:6,13:15,17:21,23:25]);

%% Parâmetros para a identificação
T = 20; %Tempo de simulação (segundos)
...
WN4 = 0.0;  %Desvio padrão na Atuação   (tau)
...
%    Ng = [g1,g2,g3,0,0,0]';
    ...
    V = [dNu1 0 0 0 0 Nu1 0 0 0 0 QNu1 0 0 0 0 g1;
         0 dNu2 0 0 0 0 Nu2 0 0 0 0 QNu2 0 0 0 g2;
         0 0 dNu3 0 0 0 0 Nu3 0 0 0 0 QNu3 0 0 g3;
         0 0 0 dNu5 0 0 0 0 Nu5 0 0 0 0 QNu5 0 0;
         0 0 0 0 dNu6 0 0 0 0 Nu6 0 0 0 0 QNu6 0;
        ];
